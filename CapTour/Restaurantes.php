        ...
        <header class = "flex header-sm">
            <div class = "container">
                <div class = "header-title">
                    <h1>Restaurantes</h1>
                    <p>Conheça as mais diversas opções de gastronomia da região mineira.</p>
                </div>
            </div>
        </header>
        <!-- header -->
        ...
        <section id = "about" class = "py-4">
            <div class = "container">
                <div class = "title-wrap">
                    <span class = "sm-title">Principais Restaurantes</span>
                    <h2 class = "lg-title">Mapa</h2>
                </div>
               <iframe src="https://www.google.com/maps/embed?pb=!1m16!1m12!1m3!1d7468.67277785757!2d-46.05293456093849!3d-20.615141034415203!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!2m1!1sRestaurantes!5e0!3m2!1spt-BR!2sbr!4v1663605020464!5m2!1spt-BR!2sbr" width="100%" height="450" style="border:0;" allowfullscreen="" loading="lazy" referrerpolicy="no-referrer-when-downgrade"></iframe>
        </section>
        <!-- final da seção dos restaurantes -->
